...
public class ProgramSca implements SafeIterator<String> {
  ...
  public ProgramSca(SafeIterator<Interpretable> checkableStream, Checker checker, SemanticEnvironment env,
  ...
  private SafeIterationResult<String> buildCorrectResult(SafeIterationResult<Interpretable> checkableStream,
