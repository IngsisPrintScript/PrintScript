...
public class DefaultScaFactory implements ScaFactory {
    private final PeekableIteratorFactory<Interpretable> checkablePeekableIteratorFactory;

    public DefaultScaFactory(
            PeekableIteratorFactory<Interpretable> checkablePeekableIteratorFactory) {
