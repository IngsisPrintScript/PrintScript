...
public final class DefaultInterpreterVisitor implements Interpreter {
  ...
  public Result<String> interpret(DeclarationKeywordNode declarationKeywordNode) {
    Result<Object> evaluateExpressionResult = this.interpret(declarationKeywordNode.expressionNode());
    ...
    Result<VariableEntry> declareVarResult = runtime.getCurrentEnvironment()
        .createVariable(
