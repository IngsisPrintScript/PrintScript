...
class MultiplicationSolutionStrategyTest {
    @Test
    void multipliesNumbers() {
        MultiplicationSolutionStrategy strat = new MultiplicationSolutionStrategy(new com.ingsis.interpreter.visitor.expression.strategies.FinalStrategy());
