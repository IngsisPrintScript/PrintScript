...
public final class LetNodeCorrectTypeEventHandler implements NodeEventHandler<Node> {
    ...
    public CheckResult handle(Node node, SemanticEnvironment env) {
        ...
        Types actualType =
                new DefaultExpressionTypeGetter()
                        .getType(declarationKeywordNode.expressionNode(), env);
