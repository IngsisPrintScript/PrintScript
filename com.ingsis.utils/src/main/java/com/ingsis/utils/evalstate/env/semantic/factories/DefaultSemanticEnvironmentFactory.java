...
public class DefaultSemanticEnvironmentFactory implements SemanticEnvironmentFactory {
    ...
    public SemanticEnvironment root() {
        ...
        env = env.define("println", new SemanticBinding.FunctionBinding(Types.NIL));
        env = env.define("readEnv", new SemanticBinding.FunctionBinding(Types.STRING));
        env = env.define("readInput", new SemanticBinding.FunctionBinding(Types.UNDEFINED));
        return env;
    }
}
