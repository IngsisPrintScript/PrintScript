...
public enum TokenType {
  ...
  public static final Set<TokenType> SEPARATORS = Set.of(
      LPAREN, RPAREN, LBRACE, RBRACE, COLON, SEMICOLON, COMMA, SPACE, NEWLINE, TAB, CRETURN);
  ...
  public static boolean isKeyword(String input) {
    return input != null && KEYWORDS.stream()
        .anyMatch(k -> k.fixedLexeme.equals(input));
  }

  public static boolean isType(String type) {
    return type != null && TYPES.stream()
        .anyMatch(k -> k.fixedLexeme.equals(type));
  }

  public static boolean isOperator(String input) {
    return input != null && OPERATORS.stream()
        .anyMatch(o -> o.fixedLexeme.equals(input));
  }

  public static boolean isSeparator(String input) {
    return input != null && SEPARATORS.stream()
        .anyMatch(s -> s.fixedLexeme.equals(input));
  }
}
