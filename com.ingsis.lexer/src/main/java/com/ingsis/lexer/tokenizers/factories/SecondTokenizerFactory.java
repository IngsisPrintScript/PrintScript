...
public final class SecondTokenizerFactory implements TokenizerFactory {
  ...
  private Tokenizer operatorTokenizer(Tokenizer nextTokenizer) {
    ...
    for (String operator : operators) {
      registry.registerTokenizer(new GenericOperatorTokenizer(tokenFactory, operator, resultFactory));
    }
    return registry;
  }
  ...
  private Tokenizer separatorTokenizer(Tokenizer nextTokenizer) {
    ...
    for (String separator : separators) {
      registry.registerTokenizer(new GenericSeparatorTokenizer(tokenFactory, separator, resultFactory));
    }
