...
public final class GenericOperatorTokenizer implements Tokenizer {
  ...
  public GenericOperatorTokenizer(TokenFactory tokenFactory, String template, ResultFactory resultFactory) {
  ...
  public Result<Token> tokenize(String input, Integer line, Integer column) {
    ...
    return resultFactory.createCorrectResult(tokenFactory.createOperatorToken(input, line, column));
  }
}
