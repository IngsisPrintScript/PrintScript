...
public final class LeftBraceTokenizer extends PunctuationTokenizer {
    private final TokenFactoryInterface TOKEN_FACTORY;

    public LeftBraceTokenizer() {
        super();
    ...
    public Result<TokenInterface> tokenize(String input) {
        ...
        return new CorrectResult<>(TOKEN_FACTORY.createPunctuationToken("LEFT_BRACE", "{"));
    }
}
