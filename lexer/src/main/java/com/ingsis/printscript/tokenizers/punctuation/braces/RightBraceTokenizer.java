...
package com.ingsis.printscript.tokenizers.punctuation.braces;
...
public final class RightBraceTokenizer extends PunctuationTokenizer {
    private final TokenFactoryInterface TOKEN_FACTORY;

    public RightBraceTokenizer() {
        super();
    ...
    public Result<TokenInterface> tokenize(String input) {
        ...
        return new CorrectResult<>(TOKEN_FACTORY.createPunctuationToken("RIGHT_BRACE", "}"));
    }
}
