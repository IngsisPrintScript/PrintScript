...
public final class CliEngine implements Engine {
  ...
  private SemanticFactory createSemanticFactory() {
    ...
    LexerFactory lexerFactory = new InMemoryLexerFactory(
        charStreamFactory, tokenizerFactory);
    ...
    return new DefaultSemanticFactory(syntacticFactory, resultFactory, DefaultRuntime.getInstance());
  }
  ...
  private EventsChecker buildFormatterChecker() {
    ...
    Checker checker = new DefaultCheckerFactory().createInMemoryEventBasedChecker(publishersFactory);
