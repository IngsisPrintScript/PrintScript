...
public class DefaultEngine implements Engine {
  ...
  public DefaultEngine(ExecuteService executeService, FormatService formatService, LintService lintService) {
  ...
  @Override
  public Result<String> interpret(Version version, OutputEmitter emitter, InputSupplier supplier, InputStream in) {
    return executeService.execute(version, emitter, supplier, in);
  }

  @Override
  public Result<String> format(InputStream in, InputStream config, Writer writer, Version version) {
    return formatService.format(version, in, writer);
  }
