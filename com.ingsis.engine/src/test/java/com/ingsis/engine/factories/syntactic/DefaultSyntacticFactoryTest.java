...
class DefaultSyntacticFactoryTest {
    ...
    @BeforeEach
    void setup() {
        factory = new DefaultSyntacticFactory(
                new com.ingsis.engine.factories.tokenstream.TokenStreamFactory() {
                    @Override
                    public com.ingsis.tokenstream.TokenStream createCliTokenStream(Queue<Character> buffer) {
                        return new com.ingsis.tokenstream.TokenStream() {
                            ...
                            @Override
                            public com.ingsis.result.Result<com.ingsis.tokens.Token> consume(com.ingsis.tokens.Token tokenTemplate) {
                                return new com.ingsis.result.IncorrectResult<>("no");
                            }
                    ...
                    @Override
                    public com.ingsis.tokenstream.TokenStream createFileTokenStream(Path filePath) throws IOException {
                ...
                new com.ingsis.syntactic.factories.ParserChainFactory() {
                    ...
                    public com.ingsis.syntactic.parsers.Parser<com.ingsis.nodes.Node> createDefaultChain() {
                        return new com.ingsis.syntactic.parsers.Parser<com.ingsis.nodes.Node>() {
                            @Override
                            public com.ingsis.result.Result<com.ingsis.nodes.Node> parse(com.ingsis.tokenstream.TokenStream ts) {
                                return new com.ingsis.result.IncorrectResult<>("no");
                            }
                        };
                    }
                    ...
                    @Override
                    public com.ingsis.syntactic.parsers.Parser<com.ingsis.nodes.expression.ExpressionNode> createExpressionChain() {
                        return new com.ingsis.syntactic.parsers.Parser<com.ingsis.nodes.expression.ExpressionNode>() {
                            @Override
                            public com.ingsis.result.Result<com.ingsis.nodes.expression.ExpressionNode> parse(com.ingsis.tokenstream.TokenStream ts) {
                                return new com.ingsis.result.IncorrectResult<>("no");
                            }
                        };
                    }
