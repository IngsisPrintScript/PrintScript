...
class EventsCheckerAdditionalTest {
    ...
    void ifNodeElseBodyShortCircuitsOnFailure() {
        ...
        class OkNode implements Node, com.ingsis.visitors.Checkable {
            ...
            @Override public com.ingsis.result.Result<String> acceptChecker(com.ingsis.visitors.Checker checker) { return new CorrectResult<>("ok"); }
        }
        ...
        class BadNode implements Node, com.ingsis.visitors.Checkable {
            ...
            @Override public Integer column() { return 1; }
            @Override public com.ingsis.result.Result<String> acceptVisitor(com.ingsis.visitors.Visitor visitor) { return new CorrectResult<>("v"); }
            @Override public com.ingsis.result.Result<String> acceptChecker(com.ingsis.visitors.Checker checker) { return new IncorrectResult<>("else-bad"); }
        }
    ...
    void dispatchUsesPublisherResultCorrectAndIncorrect() {
        ...
        PublishersFactory badPf = new PublishersFactory() {
            @Override
            public com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<com.ingsis.nodes.keyword.DeclarationKeywordNode> createLetNodePublisher() {
                return new com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<>(List.of(node -> new IncorrectResult<>("pub-bad")));
            }
        ...
        ExpressionNode expr = new ExpressionNode() {
            @Override public java.util.List<ExpressionNode> children() { return List.of(); }
            @Override public Boolean isTerminalNode() { return true; }
            @Override public String symbol() { return "x"; }
            @Override public com.ingsis.result.Result<String> acceptChecker(com.ingsis.visitors.Checker checker) { return checker.check(this); }
            @Override public com.ingsis.result.Result<String> acceptInterpreter(com.ingsis.visitors.Interpreter interpreter) { return new CorrectResult<>("interp"); }
            @Override public com.ingsis.result.Result<String> acceptVisitor(com.ingsis.visitors.Visitor visitor) { return new CorrectResult<>("visit"); }
            @Override public Integer line() { return 0; }
        ...
        PublishersFactory okPf = new PublishersFactory() {
            @Override
            public com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<com.ingsis.nodes.keyword.DeclarationKeywordNode> createLetNodePublisher() {
                return new com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<>(List.of(node -> new CorrectResult<>("ok")));
            }
    ...
    void dispatchMissingPublisherReturnsIncorrect_usingReflection() throws Exception {
        PublishersFactory pf = new PublishersFactory() {
            @Override
            public com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<com.ingsis.nodes.keyword.DeclarationKeywordNode> createLetNodePublisher() { return new com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<>(List.of()); }
            @Override
            public com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<com.ingsis.nodes.keyword.IfKeywordNode> createConditionalNodePublisher() { return new com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<>(List.of()); }
            @Override
            public com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<com.ingsis.nodes.expression.ExpressionNode> createExpressionNodePublisher() { return new com.ingsis.rule.observer.publishers.GenericNodeEventPublisher<>(List.of()); }
        };
        EventsChecker checker = new EventsChecker(pf);
        ...
        Method dispatch = EventsChecker.class.getDeclaredMethod("dispatch", Node.class, Class.class);
