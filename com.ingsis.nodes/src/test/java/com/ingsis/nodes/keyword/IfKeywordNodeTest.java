...
public class IfKeywordNodeTest {
    ...
    @BeforeEach
    public void setUp() {
        com.ingsis.nodes.expression.identifier.IdentifierNode cond = new com.ingsis.nodes.expression.identifier.IdentifierNode("c",1,1);
        withElse = new IfKeywordNode(cond, List.of(), List.of(new com.ingsis.nodes.expression.literal.LiteralNode("1",1,2)),1,1);
    ...
    public void acceptMethodsDelegate() {
        com.ingsis.visitors.Checker checker = new com.ingsis.visitors.Checker() {
            @Override
            public Result<String> check(IfKeywordNode ifKeywordNode) { return new CorrectResult<>("ok"); }
            @Override
            public Result<String> check(com.ingsis.nodes.keyword.DeclarationKeywordNode declarationKeywordNode) { return new CorrectResult<>("ok"); }
            @Override
        ...
        com.ingsis.visitors.Interpreter interpreter = new com.ingsis.visitors.Interpreter() {
            @Override
            public Result<String> interpret(IfKeywordNode ifKeywordNode) { return new CorrectResult<>("ok"); }
            @Override
            public Result<String> interpret(com.ingsis.nodes.keyword.DeclarationKeywordNode declarationKeywordNode) { return new CorrectResult<>("ok"); }
            @Override
        ...
        com.ingsis.visitors.Visitor visitor = new com.ingsis.visitors.Visitor() {
            @Override
            public Result<String> visit(IfKeywordNode ifKeywordNode) { return new CorrectResult<>("ok"); }
            @Override
