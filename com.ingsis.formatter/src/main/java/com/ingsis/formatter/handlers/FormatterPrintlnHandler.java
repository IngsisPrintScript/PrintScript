...
public class FormatterPrintlnHandler implements NodeEventHandler<ExpressionNode> {
  ...
  public FormatterPrintlnHandler(Integer amountOfLinesBeforeCall, NodeEventHandler<ExpressionNode> expressionHandler,
  ...
  public Result<String> handle(ExpressionNode node) {
    ...
    sb.append("( ");
    Result<String> parseExpressionResult = expressionHandler.handle(callFunctionNode.children().get(0));
